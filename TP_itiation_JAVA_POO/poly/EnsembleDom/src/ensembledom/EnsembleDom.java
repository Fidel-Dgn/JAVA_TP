...
public class EnsembleDom {
    ...
    public static void main(String[] args) {
        EnsembleDom ensemble = new EnsembleDom();
        ensemble.consTotal();
        System.out.println("Ensemble complet :");
        ...
        System.out.println("\nRetirer un domino (dernier) :");
        Domino removed = ensemble.remove();
        System.out.println("Retiré : " + removed);
        System.out.println("Ensemble après retrait : " + ensemble);

        System.out.println("\nTaille actuelle : " + ensemble.taille());
    }
}
