...
public class Domino {
    ...
    public static void main(String[] args) {
        // Test de la classe Domino
        Domino d1 = new Domino(3, 5);
        Domino d2 = new Domino(5, 3);
        Domino d3 = new Domino();

        System.out.println("Domino d1 : " + d1);
        System.out.println("Domino d2 : " + d2);
        System.out.println("Domino d3 : " + d3);

        System.out.println("d1 est un double ? " + d1.isDouble());
        System.out.println("d3 est un double ? " + d3.isDouble());

        System.out.println("Points de d1 : " + d1.totalPoint());
        d1.rotate();
        System.out.println("d1 après rotation : " + d1);

        System.out.println("Comparaison entre d1 et d2 : " + d1.compareTo(d2));
    }
}
